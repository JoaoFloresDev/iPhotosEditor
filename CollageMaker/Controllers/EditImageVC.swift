                        ...
                        if i is UIView{
                            for j in i.subviews{
                                if j is ZoomImageView{
                                    ...
                                    scr.backgroundColor = UIColor.init(red: 225/255, green: 227/255, blue: 230/255, alpha: 1)
                                }
                            }
                        }
                    }
                        ...
                        if i is UIView{
                            for j in i.subviews{
                                if j is ZoomImageView{
                                    ...
                                    }else if objBtnSelectNo == 2{
                                        if j == img1_2 || j == img2_2 || j == img3_2 || j == img4_2 || j == img5_2{
                                            self.setImageScroll(scr, img)
                                        }
                                    }else if objBtnSelectNo == 3{
                                        if j == img3_3 || j == img4_3 || j == img5_3 {
                                            self.setImageScroll(scr, img)
                                        }
                                    }else if objBtnSelectNo == 4{
                                        if j == img4_4 || j == img5_4{
                                            self.setImageScroll(scr, img)
                                        }
                                    }else if objBtnSelectNo == 5{
                                        if j == img5_5{
                                            self.setImageScroll(scr, img)
                                        }
                                    }
