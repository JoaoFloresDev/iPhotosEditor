...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        labelTextField.text = @"";
        labelTextField.autocorrectionType = UITextAutocorrectionTypeYes;
...
//        rotateView.contentMode = UIViewContentModeCenter;
        ...
        [self setCloseImage:[UIImage imageNamed:@"iqsticker_close.png"]];
        [self setRotateImage:[UIImage imageNamed:@"iqsticker_rotate.png"]];
...
{
    textColor = color;
    labelTextField.textColor = color;
    [labelTextField setNeedsLayout];
}
