    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                ...
                SwiftUI.Text("Export your photo")
                    .font(.system(size: 26, weight: .semibold))
                    .multilineTextAlignment(.center)
                SwiftUI.Text("You can download all that apply in your filter.\nAlways for FREE")
                    .font(.system(size: 14))
                    .multilineTextAlignment(.center)
        ...
        .alert(isPresented: $showSuccessPopup) {
            Alert(title: SwiftUI.Text("Success"), message: SwiftUI.Text("Your export success"), dismissButton: .default(SwiftUI.Text("Close"), action: {
